 ...
 * 
 */
@WebServiceClient(name = "HelloService", targetNamespace = "http://wyz/", wsdlLocation = "http://localhost:9095/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICE_QNAME = new QName("http://wyz/", "HelloService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9095/hello?wsdl");
    ...
    public Hello getHelloPort() {
        return super.getPort(new QName("http://wyz/", "HelloPort"), Hello.class);
    }
    ...
    public Hello getHelloPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://wyz/", "HelloPort"), Hello.class, features);
    }
